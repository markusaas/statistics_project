...
ggplot(apartments_sp, aes(x=square_meters)) +
  ...
  labs(title="Kernel density of area of the apartments", x="Square meters")

ggplot(apartments_sp, aes(x=bedrooms)) +
  geom_density(size=0.8) +
  labs(title="Kernel density of the number of bedrooms", x="Number of bedrooms")

ggplot(apartments_sp, aes(x=bathrooms)) +
  geom_density(size=0.8) +
  labs(title="Kernel density of the number of bathrooms", x="Number of bathrooms")

ggplot(apartments_sp, aes(x=suites)) +
  geom_density(size=0.8) +
  labs(title="Kernel density of the number of suites", x="Number of suites")

ggplot(apartments_sp, aes(x=parking_spaces)) +
  geom_density(size=0.8) +
  labs(title="Kernel density of the number of parking spaces", x="Number of parking spaces")

ggplot(apartments_sp, aes(x=final_price)) +
  geom_density(size=0.8) +
  labs(title="Kernel density of apartment prices", x="Thousands of reais (R$)")
```
